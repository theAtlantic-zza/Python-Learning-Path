...
data = {
    ...
    "活跃广告主数": [
        3759, 2706, 2228, 1776, 3532, 2851, 3949, 3528
    ],
    "有消耗主体数": [
        142, 101, 119, 79, 130, 151, 151, 225
    ]
}
...
# 7. 标题
ax1.set_title(
    "2025/11–2026/06教育行业活跃广告主数与有消耗主体数变化",
    fontsize=17,
    pad=26
)
...
# 9. 标签偏移：教育这组 2026/02、2026/06 需要稍微处理
active_offsets = {
    "2025/11": (0, 10, "center"),
    "2025/12": (0, 10, "center"),
    "2026/01": (0, 10, "center"),
...
cost_offsets = {
    ...
    "2025/12": (0, -16, "center"),
    "2026/01": (0, -16, "center"),
    "2026/02": (0, 12, "center"),    # 低点，标签放上方，避免贴近底部
    "2026/03": (0, -16, "center"),
    "2026/04": (0, -16, "center"),
    "2026/05": (0, -16, "center"),
    "2026/06": (0, -16, "center"),   # 高点，标签放下方，避免贴近顶部
}
...
# 14. 保存，注意先保存再显示
fig.savefig(
    "2025-11至2026-06教育行业活跃广告主数与有消耗主体数变化.png",
    dpi=300,
    bbox_inches="tight",
    facecolor="white"
)

...
data = {
    ...
    "活跃广告主数": [
        18185, 17290, 16974, 8462, 15358, 14704, 13390, 14538
    ],
    "有消耗主体数": [
        1186, 1159, 1198, 672, 969, 788, 679, 692
    ]
}
...
ax1.set_ylim(0, max(df["活跃广告主数"]) * 1.15)
ax1.margins(x=0.06)
...
ax2.set_ylim(600, 1250)

# 7. 标题
ax1.set_title(
    "2025/11–2026/06汽车行业活跃广告主数与有消耗主体数变化",
    fontsize=17,
    pad=26
)
...
cost_offsets = {
    "2025/11": (0, 14, "center"),
    "2025/12": (0, 14, "center"),
    "2026/01": (0, 10, "center"),   # 这里往上放，避免和蓝线太近
    "2026/02": (0, -14, "center"),
    "2026/03": (0, -14, "center"),
    "2026/04": (0, -14, "center"),
    "2026/05": (0, -14, "center"),
...
for x, y in zip(df["时间"], df["有消耗主体数"]):
    dx, dy, ha = cost_offsets.get(x, (0, -14, "center"))
    ax2.annotate(
        f"{y}",
        xy=(x, y),
        xytext=(dx, dy),
...
# 14. 保存（先保存再显示）
fig.savefig(
    "2025-11至2026-06汽车行业活跃广告主数与有消耗主体数变化.png",
    dpi=300,
    bbox_inches="tight",
    facecolor="white"
)
